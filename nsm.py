...
def obtener_ruta_recurso(nombre_archivo):
    ...
    try:
        ...
        print(f"Error al obtener ruta del recurso: {e}")
        return nombre_archivo
# Función para cargar la imagen de fondo
def cargar_imagen_fondo(width, height):
    try:
        # Usar la función obtener_ruta_recurso para obtener la ruta correcta
        ruta_imagen = obtener_ruta_recurso("nsm.png")
...
def abrir_aplicacion_usuario():
    ...
    # Cargar icono usando la función obtener_ruta_recurso
    try:
        icono_path = obtener_ruta_recurso('nsmschool.ico')
